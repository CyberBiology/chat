...
Геном выполнен в виде последовательности инструкций с условными переходами,
который выполняется ботом. 
Мутация может изменить случайную команду на другую.
Хорошо это или плохо, решит естественный отбор.

Статья на Хабре об этом проекте.

https://habr.com/ru/post/418545/

Последнее видео из серии "Мозг для змейки", где проведён интересный эксперимент, 
когда естественному отбору подверглась "идеальная" змейка, чей "мозг" создан вручную.

https://youtu.be/n-KDlkv__B8

Первое видео серии "Эволюция цифровых деревьев"

https://youtu.be/WTh-gNZxTM8
...
![Genesis. Demo v0.4](/img/amyasnikov_genesis_v0.4.gif)
